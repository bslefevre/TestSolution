...
namespace TestBusinessObject
{
    public static class AlureBuildNotes
    {
        public static IOrderedEnumerable<AlureWorkItem> GetAlureWorkItemCollection()
        {
            ...
            var childrenWorkItemLinkInfoCollection = workItemLinkInfoCollection.Where(x => x.SourceId == 12522); //> 0);
        ...
        public static void CreateExcelDocumentWithData(AlureCell alureCell)
        {
            ...
            xlWorkBook.SaveAs("C:\\Buildnotes.xls", XlFileFormat.xlWorkbookNormal, misValue, misValue, misValue, misValue, XlSaveAsAccessMode.xlExclusive, misValue, misValue, misValue, misValue, misValue);
